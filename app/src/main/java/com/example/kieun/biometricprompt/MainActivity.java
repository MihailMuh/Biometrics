...
public class MainActivity extends AppCompatActivity
    ...
    private KeyPair generateKeyPair() throws Exception {
        ...
        KeyGenParameterSpec.Builder builder = new KeyGenParameterSpec.Builder(MainActivity.KEY_NAME,
    ...
    private KeyPair getKeyPair() throws Exception {
        ...
        if (keyStore.containsAlias(MainActivity.KEY_NAME)) {
            ...
            // Get private key
            PrivateKey privateKey = (PrivateKey) keyStore.getKey(MainActivity.KEY_NAME, null);
            // Return a key pair
