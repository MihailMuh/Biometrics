...
public class Biometrics {
    ...
    private void showBiometricPrompt(Signature signature) {
        ...
        BiometricPrompt mBiometricPrompt = new BiometricPrompt((FragmentActivity) applicationContext, getMainThreadExecutor(), authenticationCallback);
    ...
    private boolean canAuthenticateWithStrongBiometrics() {
        return BiometricManager.from(applicationContext).canAuthenticate(BiometricManager.Authenticators.BIOMETRIC_STRONG) == BiometricManager.BIOMETRIC_SUCCESS;
    }
